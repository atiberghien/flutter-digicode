...
class PassCodeScreen extends ConsumerStatefulWidget {
  ...
  const PassCodeScreen({Key? key, required this.user, required this.target, required this.color}) : super(key: key);
        ...
        Row(
          ...
          children: List.generate(4, (index) {
            return Container(
              ...
              margin: const EdgeInsets.all(5),
              decoration: BoxDecoration(
                color: index < digits.length ? widget.color : Colors.black12,
                borderRadius: BorderRadius.circular(10),
              ),
            );
          }),
